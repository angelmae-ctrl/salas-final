...
show_pages(
    [   
        ...
        Section("MAIN PAGE"),
        Page("pages/myself.py", "👩‍💻 EVERYTHING ABOUT ME", "1️⃣", in_section=True),
        Page("pages/specification.py", "📋 APP SPECIFICATION", "2️⃣", in_section=True),
        Page("pages/qmlearnings.py", "📚🔍 LEARNINGS", "3️⃣", in_section=True),
